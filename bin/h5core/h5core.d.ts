...
interface $gmType {
    ...
    showNSLogData(data?: string, ...cmds: number[]): any;
    /**
     * 使用黑名单模式，进行输出
     *
     * @param {...number[]} cmds
    ...
    abstract class NetService {
        ...
        */
        ...
        protected $writeNSLog: {
            (time: number, msgType: string, type: "send" | "recv", cmd: number, data?: any): void;
        };
...
declare module junyou {
    ...
    const PBMessageUtils: {
        ...
        readFrom: (msgType: string | number, bytes: ByteArray, len?: number) => Object;
...
declare module junyou {
    class ComboBox extends Component {
        ...
        bindChildren(): void;
        listbg: ScaleBitmap;
        list: PageList<any, any>;
        private _isOpen;
        private _extra;
        isOpen: boolean;
        labelFunction: Function;
        createList(pageList: PageList<any, any>, offx?: number, offy?: number): void;
        protected onItemTouch: (e: egret.Event) => void;
        protected onItemSelect: (e: egret.Event) => void;
        protected onBtnTouch(e: egret.Event): void;
        /**显示 */
        ...
        /**当前数据 */
        getSelectData(): any;
        setData(data: any[], moren?: number, labelFunction?: Function): void;
        setListBg(uri: string, className: string): void;
        listBgWidth: number;
        extra: any;
    }
}
...
declare module junyou {
     ...
     */
    var DataLocator: {
        regParser: (key: string, parser: ConfigDataParser) => void;
        parsePakedDatas(): void;
        regCommonParser(key: string, CfgCreator: 0 | (new () => Cfg), idkey?: string): void;
    };
    /**
     * 配置数据解析函数
     */
...
declare module junyou {
     ...
     *
     */
    class ComboBoxCreator extends BaseCreator<ComboBox> {
        constructor();
        parseSelfData(data: any): void;
    }
}
